    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @can('create', App\Models\Vacante::class)
                    <a class="text-white mr-2 w-7 h-7 bg-black hover:bg-indigo-800 rounded-full flex flex-col justify-center items-center
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (auth()->user()->rol === 2)
                <div class="flex gap-2 items-center p-3">
                    <a class="text-white w-7 h-7 bg-black hover:bg-indigo-800 rounded-full flex flex-col justify-center items-center
                    text-sm font-extrabold"
                    href="{{ route('notificaciones')}}">
                        {{Auth::user()->unreadNotifications->count()}}
                    </a>
                    <p class="text-base font-medium text-gray-400">Notificaciones</p>
                </div>
                @endif
        </div>
